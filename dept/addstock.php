...
<?php include 'layout/header.php';
    ...
    $deptid = $check['deptid'];
        ...
        $date = htmlentities(mysqli_real_escape_string($db, $_POST['date']));
        $action = htmlentities(mysqli_real_escape_string($db, $_POST['action']));
        echo $action;
        $form_sub="INSERT INTO `stock`(`commodity`, `action`, `amount`, `date`, `deptid`) VALUES ('$commodity','$action','$amount','$date','$deptid')";
