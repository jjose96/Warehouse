...
<?php include 'layout/header.php';
    ...
    if(!empty($_GET['id'])){
        ...
        $deptid = $check['deptid'];
    $id = htmlentities(mysqli_real_escape_string($db, $_GET['id']));
    $c= "SELECT * FROM CDETAILS where deptid='$deptid' and coomodity='$id'";
    $ex= mysqli_query($db,$c);
    $rel= mysqli_fetch_array($ex);
    if (!empty($_POST))  {
        $commodity = htmlentities(mysqli_real_escape_string($db, $_POST['commodity']));
        $capacity = htmlentities(mysqli_real_escape_string($db, $_POST['capacity']));
        $form_sub="UPDATE `cdetails` SET `coomodity`='$commodity',`capacity`='$capacity' WHERE deptid='$deptid'";
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="dept">
                                <i class="fas fa-tachometer-alt"></i>Department Head</a>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="../dept/dashboard">
                                <i class="fas fa-chart-bar"></i>Commodity</a>
                        </li>
                        <li>
                            <a href="../dept/stock">
                                <i class="fas fa-table"></i>Stock Management</a>
                        </li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">DEPARTMENT HEAD</a>
                                        </div>
                ...
                <div class="page-wrapper">
                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <form action="" method="post" class="register-form" id="register-form">
                                                        ...
                                                        <h2>Assign Capacity </h2><br>
                                                
                                                  Commodoties: <select ng-model="myselect" name="commodity" required>
                                                  <?php
                  ...
                  ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="au-input au-input--full" type="text" name="capacity" placeholder="capacity" value="<?php echo $rel['capacity'] ?>" required>
                                        </div>
                             
                                            <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" style="width: 250px;">Update</button>  
                                        </form>
