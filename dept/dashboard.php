                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="../dept/dashboard">
                                <i class="fas fa-chart-bar"></i>Commodity details</a>
                        </li>
                        <li>
                            <a href="../dept/stock">
                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <div style="margin-left:100px">
                                            <div class="open-btn">
                                                <a href="../dept/addcdetails" class="btn btn-primary btn-lg active open-button" role="button" aria-pressed="true">Add Commodity</a>
                                              </div>
                    ...
                    <div class="login-wrap">
                        <div class="login-content">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                  <tr>
                                                    <th scope="col"><h5>Commodity Name</h5></th>
                                                    <th scope="col"><h5>Capacity(in Tons)</h5></th>
                                                    <th scope="col"><h5>Edit action</h5></th>
                                                    <th scope="col"><h5>Delete Action</h5></th>
                                                  </tr>
                                                </thead>
                                                <tbody>
                                                <?php
                                           $sql="SELECT * FROM `department`,`cdetails` WHERE department.deptid = cdetails.deptid and username='$user_check'";
                                                 $exec=mysqli_query($db,$sql);
                  while($row=mysqli_fetch_array($exec)){
                      echo "<tr><td>".$row['coomodity']."</td>";
                      echo "<td>".$row['capacity']."</td>";
                      echo "<td><a class='btn-primary' href='../dept/editcdetails?id=".$row['coomodity']."'> Edit</a></b></td>";
                      echo "<td><b> <a class='btn-primary' href=../dept/deletecom?id=".$row['coomodity']." "; echo "onclick='return confirm(\"Are you sure you want to delete\")'> Delete</a></b></td></tr>";
                  }
                  ?>
                                                </tbody>
                                              </table>
