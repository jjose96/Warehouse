...
<?php include 'layout/header.php';
    ...
    $deptid = $check['deptid'];
        ...
        $form_sub="INSERT INTO `cdetails`(`deptid`, `coomodity`, `capacity`) VALUES ('$deptid','$commodity','$capacity')";
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="../dept/dashboard">
                ...
                <div class="page-wrapper">
                  ...
                  ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="au-input au-input--full" type="text" name="capacity" placeholder="capacity" required>
                                        </div>
