                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <div style="margin-left:100px">
                                            <div class="open-btn">
                                                <a href="../dept/addstock" class="btn btn-primary btn-lg active open-button" role="button" aria-pressed="true">Add Stock</a>
                                              </div>
                    ...
                    <div class="login-wrap">
                        <div class="login-content">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                  <tr>
                                                    <th scope="col"><h5>Commodity</h5></th>
                                                    <th scope="col"><h5>Action</h5></th>
                                                    <th scope="col"><h5>Amount (in Tons)</h5></th>
                                                ...
                                                $deptid = $check['deptid'];
                  $sql="SELECT * from stock where deptid='$deptid'";
