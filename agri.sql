...
--
-- Host: localhost
-- Generation Time: Sep 04, 2020 at 08:20 AM
...
INSERT INTO `cdetails` (`deptid`, `coomodity`, `capacity`) VALUES
(1, 'ginger', 2000),
(1, 'ginger', 3000),
(18, 'sorghum', 6000),
(18, 'maize', 300),
...
INSERT INTO `commodity` (`itemid`, `commodity`) VALUES
(12, 'ginger'),
(25, 'wheat'),
(26, 'barley'),
(27, 'sorghum'),
...
INSERT INTO `department` (`deptid`, `name`, `email`, `regid`, `username`, `password`) VALUES
(18, 'Karthik Govind', 'karthik@gmail.com', 1550, 'karthiksurya', 'karthik'),
(19, 'Sivakumar S', 'sivakumars@gmail.com', 63535, 'shivakumars', 'sivakumar'),
(20, 'Jose Kuriyan', 'josekurian@gmail.com', 5345, 'josekurian', 'josekurian'),
(21, 'Fathima Nazar', 'fnzr@gmail.com', 2345, 'fatimanazar', 'fatimanazar'),
(22, 'Kalyani Damodar', 'kalyanikalavani@gmail.com', 1550, 'kalyanidamodar', 'kalyanidamodar'),
(23, 'Aravind V', 'aravindvkarakkad@gmail.com', 63535, 'aravindv', 'aravindv'),
(24, 'Jinu Sam', 'jinusam124@gmail.com', 9562, 'jinusam', 'jinusam'),
(25, 'Dayal', 'djfhjdhfd@fjhe.coom', 567, 'dfdf', 'fdfdfdfd');
...
INSERT INTO `godown` (`regid`, `title`, `address`, `city`, `state`, `capacity`) VALUES
(567, 'rahul godown', 'andra pradesh', 'Cuddapah', 'Andhra Pradhesh', 80000),
(767, 'Kollam', 'sdsdsd', 'Kollam', 'Kerala', 2000),
(1167, 'Kerala State  Warehouse', 'Karicode, Kollam', 'Kollam', 'Kerala', 4600),
(1550, 'eklm godown', 'khSDflkajdljkghasgj', 'Cuddapah', 'Nagaland', 12390),
(2345, 'shanmukam godown', 'shanmukam godown, bihar', 'Adoni', 'Bihar', 100000),
(5345, 'surya godown', 'surya godown,goa', 'Anakapalle', 'Goa', 140000),
(6550, 'KSWC godown ', 'Kalavoor, Cherthala', 'Alappuzha', 'Kerala', 6700),
(9562, 'rashmika godown', 'rashmika godown', 'Kurichi', 'Kerala', 900000),
(63535, 'vijay godown', 'vijay godown assam', 'Bodhan', 'Assam', 80000);

-- --------------------------------------------------------

--
-- Table structure for table `rfidtest`
--
...
INSERT INTO `stock` (`commodity`, `action`, `amount`, `date`) VALUES
('rice', 'import', 1234, '2020-02-04');
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `department_ibfk_1` FOREIGN KEY (`regid`) REFERENCES `godown` (`regid`);
COMMIT;
