...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2020 at 02:38 PM
...
(21, 'Fathisds', 'fnzr@gmail.com', 2345, 'fatimanazar', 'fatimanazar'),
...
(567, 'rahul godowndfd', 'andra pradesh', 'Chittur', 'Nagaland', 80000),
...
(25656, 'sdsdsasatest', 'sdsdssd', 'Dharmavaram', 'Karnataka', 620),
(45454, 'gfgfg', 'fgfgf', 'Cuddapah', 'Andaman', 565),
...
INSERT INTO `stock` (`commodity`, `action`, `amount`, `date`, `deptid`) VALUES
('barley', 1, 500, '2020-11-25', 20),
('pearl', 0, 600, '2020-11-25', 20),
('ginger', 0, 687, '2020-11-25', 20);
...
--
ALTER TABLE `department`
  MODIFY `deptid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
