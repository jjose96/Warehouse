   ...
   if(!empty($_GET['id'])){
    if(is_numeric($_GET['id']))
    {
     if (!empty($_POST))  {
        ...
        $form_sub="UPDATE `department` SET `name`='$name',`email`='$email',`regid`='$regid',`username`='$username',`password`='$password' WHERE deptid=".$_GET['id'];
                        ...
                        <div class="container">
                            <div class="login-wrap">
                                <div class="login-content">
                                    ...
                                    $mys="SELECT * FROM department where deptid=".$_GET['id'];
                                    ...
                                    <form action="" method="post" class="register-form" id="register-form">
                                       ...
                                       <div class="form-group">
                                                   <label>Name</label>
                                                   <input class="au-input au-input--full" type="text" name="name" placeholder="Name" required value="<?php echo $sel['name'] ?>">
                                       </div>
                                       <div class="form-group">
                                                   <label>Godown Reg Id</label>
                                                   <input class="au-input au-input--full" type="text" name="regid" placeholder="Reg Id" required value="<?php echo $sel['regid'] ?>">
                                       </div>

                                   <div class="form-group">
                                       <label>Email</label>
                                       <input class="au-input au-input--full" type="text" name="email" placeholder="email" required value="<?php echo $sel['email'] ?>">
                                   </div>
                                  
                                  
                                       <div class="form-group">
                                           <label>Username</label>
                                           <input class="au-input au-input--full" type="text" name="username" placeholder="Username" required value="<?php echo $sel['username'] ?>">
                                       </div>
                                       <div class="form-group">
                                           <label>Password</label>
                                           <input class="au-input au-input--full" type="password" name="password" placeholder="Password" required value="<?php echo $sel['password'] ?>">
                                       </div>
