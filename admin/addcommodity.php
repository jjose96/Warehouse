<html lang="en"><head>
    ...
    include 'session.php';
    if (!empty($_POST))  {
          $itemid = htmlentities(mysqli_real_escape_string($db, $_POST['itemid']));
          $commodity = htmlentities(mysqli_real_escape_string($db, $_POST['commodity']));
          $form_sub="INSERT INTO `commodity`(`itemid`, `commodity`) VALUES ('$itemid','$commodity')";
                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <form action="" method="post" class="register-form" id="register-form">
                                                        ...
                                                        <h2>Commodity Registration </h2><br>
                                                <div class="form-group">
                                                            <label>Item ID</label>
                                                            <input class="au-input au-input--full" type="text" name="itemid" placeholder="Item Id" required>
                                                </div>
                                            <div class="form-group">
                                                <label>Commodity Name :</label>
                                                <input class="au-input au-input--full" type="text" name="commodity" placeholder="Commodity name" required>
                                            </div>
