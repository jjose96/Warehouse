                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <div style="margin-left:100px">
                                            <div class="open-btn">
                                                <a href="../admin/addgodown" class="btn btn-primary btn-lg active open-button" role="button" aria-pressed="true">New Godown Registration</a>
                                              </div>
            ...
            <div class="page-content--bge5">
                <div class="container">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                  <tr>
                                                    ...
                                                    <th scope="col"><h5>Capacity</h5></th>
                  ...
                  while($row=mysqli_fetch_array($exec)){
                      ...
                      echo "<td><a class='btn-primary' href='../admin/editgodown?id=".$row['regid']."'> Edit</a></b></td>";
                      echo "<td><b> <a class='btn-primary' href='../admin/delete?id=".$row['regid']."' onclick='return confirm(\"Are you sure you want to delete this godown, Deleting godown delete all department associated with the godown\")'> Delete</a></b></td></tr>";
                  }
