                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <div style="margin-left:100px">
                                            <div class="open-btn">
                                                <a href="../admin/adddepartment" class="btn btn-primary btn-lg active open-button" role="button" aria-pressed="true">New Department Head Registration</a>
                                              </div>
            ...
            <div class="page-content--bge5">
                <div class="container">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                  <tr>
                                                    ...
                                                    <th scope="col"><h5>Reg Id</h5></th>
                                                    <th scope="col"><h5>City</h5></th>
                                                    <th scope="col"><h5>Godown</h5></th>
                                                ...
                                                <tbody>
                                                <?php
                                           $sql="SELECT * FROM `department`,`godown` WHERE department.regid = godown.regid";
                  ...
                  while($row=mysqli_fetch_array($exec)){
                      ...
                      echo "<td><a class='btn-primary' href='../admin/editdepartment?id=".$row['deptid']."'> Edit</a></b></td>";
                      echo "<td><b> <a class='btn-primary' href='../admin/deletedep?id=".$row['deptid']."' onclick='return confirm(\"Are you sure you want to delete this department head\")'> Delete</a></b></td></tr>";
                  }
