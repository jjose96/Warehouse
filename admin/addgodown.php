    ...
    .open-btn {
     ...
     <?php include 'layout/header.php';
       ...
       if (!empty($_POST))  {
          ...
          $form_sub="INSERT INTO `godown`(`regid`, `title`, `address`, `city`, `state`, `capacity`) VALUES ('$regid','$title','$address','$city','$state','$capacity')";
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <form action="" method="post" class="register-form" id="register-form">
                                                        ...
                                                        <h2>Godown Registration </h2><br>
                                                <div class="form-group">
                                                            <label>Register id</label>
                                                            <input class="au-input au-input--full" type="number" name="regid" placeholder="Register Id" required>
                                                </div>
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input class="au-input au-input--full" type="text" name="title" placeholder="title" required>
                                            </div>
                                           
                                                <div class="form-group">
                                                    <label for="address">Address :</label>
                                                    <textarea id="address" class="au-input au-input--full" rows="2" cols="25" placeholder="address" name="address" required></textarea>
               ...
               <div ng-app="myApp" ng-controller="myCtrl">
                ...
                City: <select ng-model="cities" name="city" ng-change="GetDown()">
                  <?php
                  ...
                  ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="au-input au-input--full" type="number" name="capacity" placeholder="capacity" required>  
                                                </div>
