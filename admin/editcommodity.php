<html lang="en"><head>
   ...
   if(!empty($_GET['id'])){
     if (!empty($_POST))  {
        ...
        $form_sub="UPDATE `commodity` SET `commodity`='$commodity' WHERE itemid=".$_GET['id'];
         if ($db->query($form_sub) === TRUE) {
         echo "New record created successfully";
         echo "<script>document.location.href='commodity.php';</script>";
         }
     }  
                        ...
                        <div class="container">
                            <div class="login-wrap">
                                <div class="login-content">
                                    <?php
                                    $mys="SELECT * FROM commodity where itemid=".$_GET['id'];
                                    ...
                                    <div class="login-form">
                                        <form action="" method="post" class="register-form" id="register-form">
                                                        ...
                                                        <h2>Commodity Update</h2><br>
                                            <div class="form-group">
                                            
                                           
                                                <div class="form-group">
                                                    <label for="address">Commodity Name :</label>
                                                    <input class="au-input au-input--full" type="text" name="commodity" placeholder="title" value="<?php echo $sel['commodity']; ?>">
