                                ...
                                <div class="login-content">
                                    ...
                                    <div class="login-form">
                                        <div style="margin-left:100px">
                                            <div class="open-btn">
                                                <a href="../admin/addcommodity" class="btn btn-primary btn-lg active open-button" role="button" aria-pressed="true">New Commodity</a>
                                              </div>
            ...
            <div class="page-content--bge5">
                <div class="container">
                    <div class="login-wrap">
                        <div class="login-content">
                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                  <tr>
                                                    <th scope="col"><h5>Item Code</h5></th>
                  ...
                  while($row=mysqli_fetch_array($exec)){
                      ...
                      echo "<td><a class='btn-primary' href='../admin/editcommodity?id=".$row['itemid']."'> Edit</a></b></td>";
                      echo "<td><b> <a class='btn-primary' href='../admin/deletecom?id=".$row['itemid']."'' onclick='return confirm(\"Are you sure you want to delete this commodity\")'> Delete</a></b></td></tr>";
                  }
